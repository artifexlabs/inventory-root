...
This is a java application built with maven using it's internal parent at @inventory-parent/ but the apis need to be publishable as a backend so that other languages can use them,
